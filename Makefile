...
main: $(OBJ_DIR)/main.o $(OBJ_DIR)/BoardGame.o $(OBJ_DIR)/Checkers.o $(OBJ_DIR)/LigFour.o $(OBJ_DIR)/Player.o $(OBJ_DIR)/PlayerList.o
	$(CC) $(CFLAGS) $(OBJ_DIR)/main.o $(OBJ_DIR)/BoardGame.o $(OBJ_DIR)/LigFour.o $(OBJ_DIR)/Checkers.o $(OBJ_DIR)/Player.o $(OBJ_DIR)/PlayerList.o  -o main
